...
class ServerFiles  //  : public QRunnable // Data Files operations
{
public:
    DataFiles d_files;
    quint16 field_count;
    ...
    QList<PackedDataObj> PackedList;
    DFieldDescriptors FD;

    QList<DataObj*> data_obj_list;          // 1-element list to support local files interface
    QMap<obj_id_type, DataObj> dobj_map;    // map to send to client
